# Generated by Django 4.2 on 2024-02-26 16:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('location', '0014_remove_street_sity_delete_building_delete_street'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_hy', models.CharField(db_index=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('adres', models.CharField(db_index=True, max_length=70)),
